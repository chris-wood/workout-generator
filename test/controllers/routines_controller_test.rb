...
class RoutinesControllerTest < ActionController::TestCase
  ...
  test "should create routine" do
    assert_difference('Routine.count') do
      post :create, routine: { creator: @routine.creator, description: @routine.description, name: @routine.name }
    end
  ...
  test "should update routine" do
    patch :update, id: @routine, routine: { creator: @routine.creator, description: @routine.description, name: @routine.name }
    assert_redirected_to routine_path(assigns(:routine))
  end
